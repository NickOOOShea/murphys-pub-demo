    ...
    <div ref={ref} className="relative min-h-screen overflow-hidden">
      ...
      >
        <motion.div
          ...
          className="inline-flex items-center justify-center w-10 h-10 rounded-full border-2 border-emerald-500/30 text-emerald-400"
        >
          <ChevronDown size={20} />
        </motion.div>
        <p className="text-xs text-paper-200/60 mt-2 tracking-wider uppercase">
          Scroll to explore
        </p>
      </motion.div>
    </div>
